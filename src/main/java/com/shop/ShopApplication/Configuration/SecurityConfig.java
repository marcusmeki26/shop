    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        return http
                ...
                .authorizeHttpRequests(request -> request
                        .requestMatchers("/login", "/register", "/refresh") // This removes the need for the user to be authenticated first before logging in. Basically you can perform a POST method without the need of being authenticated.
                        .permitAll()
